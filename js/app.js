...
console.log("⚡ FIT DATA: App Iniciada (v7.1 - FINAL COMPLETE)...");
...
let alertTargetUid = null; // Para avisos directos
...
// --- INYECCIÓN DE ESTILOS Y UI (CSS + HTML EXTRA) ---
function injectAppUI() {
    ...
    style.textContent = `
        ...
        /* Librería Compacta (Mobile First) */
...
// --- DEFINICIONES DE FUNCIONES CLAVE EN WINDOW ---
